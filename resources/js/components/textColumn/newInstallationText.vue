<template>
    <div class="pt-5">
        <div class="d-sm-block pt-5">
            ...
            <h2>Placer le pointeur sur la carte à l'endroit où se trouve l'installation. Soyez précis. Vous pouvez zoomer dans la carte.</h2>
        </div>
        <div>
            <form id="form" class='form-creat pl-2 pr-2' @submit="submit" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group row m-0 group-class">
                    <label id="classe">Classe d'installation *: </label><br>
                ...
                <div class="form-group">
                    <label for="proprio_terrain">Propriétaire terrain</label><br/>
                ...
                <div class="form-group">
                    <label for="proprio_io">Propriétaire IO</label><br/>
                    <small class="p-2">Ce champ ne sera visible que par les administrateurs</small>
                ...
                <div class="form-group text-right ">
                    <input type="submit" id="save" class="btn btn-success  w-100" value="Soumettre">
                </div>
            </form>
        </div>
    </div>
